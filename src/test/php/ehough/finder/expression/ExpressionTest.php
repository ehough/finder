...
class ehough_finder_expression_ExpressionTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals($type, ehough_finder_expression_Expression::create($expr)->getType());
    }
    ...
    {
        $this->assertEquals($isCaseSensitive, ehough_finder_expression_Expression::create($expr)->isCaseSensitive());
    }
    ...
    {
        return array(
            array('{foo}', ehough_finder_expression_Expression::TYPE_REGEX),
            array('/foo/', ehough_finder_expression_Expression::TYPE_REGEX),
            array('foo',   ehough_finder_expression_Expression::TYPE_GLOB),
            array('foo*',  ehough_finder_expression_Expression::TYPE_GLOB),
        );
    }
